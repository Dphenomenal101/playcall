...
export const calls: CallRecord[] = [
  ...
  },
  {
    ...
    callType: "Discovery",
    dealStageBefore: "Solution-aware",
    dealStageAfter: "Vendor evaluating",
    score: 87,
    adherence: 83,
    outcome: "Closed won",
    date: "Jun 18, 2026",
    status: "Reviewed",
    pipelineAmount: "$34,000",
    lossReason: null,
    talkListenRatio: "41 / 59",
    scoreBreakdown: [
      { label: "Discovery", score: 9, outOf: 10, note: "Surfaced the process pain and stakeholder map early." },
      { label: "Qualification", score: 8, outOf: 10, note: "Budget owner confirmed by midpoint." },
      { label: "Objection Handling", score: 9, outOf: 10, note: "Reframed the migration risk cleanly." },
      { label: "Next Steps", score: 8, outOf: 10, note: "Trial kickoff booked with IT lead included." },
      { label: "Playbook Adherence", score: 8, outOf: 10, note: "Stayed on enterprise messaging throughout." },
    ],
    missedQuestions: ["Who owns the rollout timeline if IT flags a dependency?"],
    missedOpportunities: ["Could have quantified hours saved per week to anchor ROI earlier."],
    productInaccuracies: [],
    accountContext: {
      company: {
        name: "Notion",
        ...
        salesMotion: "hybrid",
        pricingModel: "self-serve",
        productSummary: "All-in-one workspace for notes, docs, and project tracking.",
        targetCustomer: "Knowledge-work teams at scaling companies.",
        likelyUseCase: "Consolidating internal docs and project tracking onto one platform.",
        relevantTechnologies: ["Slack", "GitHub", "Figma"],
        recentSignals: [{ type: "hiring", description: "Opened several enterprise sales roles", date: "2026-05-20" }],
        buyingStageHypothesis: "vendor-evaluating",
      },
      contact: {
        name: "Carlos Mendez",
        email: "carlos@notion.so",
      ...
      confidence: { company: 0.91, contact: 0.85, stage: 0.8, salesMotion: 0.82 },
      sources: { company: ["Exa company profile", "LinkedIn company page"], contact: ["LinkedIn profile"], retrievedAt: "2026-06-18T10:00:00Z" },
    },
    transcriptEvidence: [
      { title: "Strong discovery moment", quote: "Rep: Walk me through who currently owns the process when a project changes scope mid-sprint." },
    ],
    bestMoment: "Reframed migration risk as a managed rollout with IT as the named owner — buyer relaxed visibly.",
    topMissedMoment: "ROI was left qualitative when the buyer mentioned weekly syncs eating three hours per person.",
    buyerAwareFeedback: "Carlos is a director-level IT decision-maker at a 201-1000 person hybrid-motion company — the rep correctly pulled in IT early and neutralised migration risk, which is exactly the move for this buyer profile.",
    recommendedDrill: "Practice ROI anchoring for knowledge-work buyers: time-saved estimates, not just feature comparisons.",
  },
  {
    id: "call-006",
    rep: "Jessica Lee",
    ...
    callType: "Demo",
    dealStageBefore: "Vendor evaluating",
    dealStageAfter: "Committed",
    score: 92,
    adherence: 88,
    outcome: "Closed won",
    date: "Jun 17, 2026",
    status: "Reviewed",
    pipelineAmount: "$61,000",
    lossReason: null,
    talkListenRatio: "36 / 64",
    scoreBreakdown: [
      { label: "Demo Flow", score: 9, outOf: 10, note: "Opened with the buyer's stated pain, not a feature tour." },
      { label: "Objection Handling", score: 10, outOf: 10, note: "Security objection preempted and resolved with case study." },
      { label: "Product Accuracy", score: 9, outOf: 10, note: "Enterprise tier scoped correctly." },
      { label: "Next Steps", score: 9, outOf: 10, note: "Security review meeting locked with two stakeholders." },
      { label: "Playbook Adherence", score: 9, outOf: 10, note: "Followed launch framework precisely." },
    ],
    missedQuestions: [],
    missedOpportunities: ["Could have referenced a design-org case study to deepen industry fit."],
    productInaccuracies: [],
    accountContext: {
      company: {
        name: "Figma",
        ...
        salesMotion: "sales-led",
        pricingModel: "sales-assisted",
        productSummary: "Collaborative design and prototyping platform.",
        targetCustomer: "Design, product, and engineering teams at large companies.",
        likelyUseCase: "Standardizing design tooling across distributed product orgs.",
        relevantTechnologies: ["Slack", "Jira", "GitHub"],
        recentSignals: [{ type: "expansion", description: "Launched Figma for Enterprise tier", date: "2026-05-01" }],
        buyingStageHypothesis: "committed",
      },
      contact: {
        name: "Priya Nair",
      ...
      confidence: { company: 0.95, contact: 0.9, stage: 0.88, salesMotion: 0.9 },
      sources: { company: ["Exa company profile", "LinkedIn company page"], contact: ["LinkedIn profile"], retrievedAt: "2026-06-17T09:00:00Z" },
    },
    transcriptEvidence: [
      { title: "Objection handling highlight", quote: "Rep: I actually have a security review doc from a similar design org — want me to send it ahead of your IT conversation?" },
    ],
    bestMoment: "Preempted the security objection with a peer case study before IT could block the deal.",
    topMissedMoment: "A design-org case study would have shortened the remaining approval cycle.",
    buyerAwareFeedback: "Priya is a VP-level economic buyer at a 1000+ person public company in committed mode — the rep correctly read the room, kept features tight, and made the security review easy. Textbook close for this buyer profile.",
    recommendedDrill: "Practice enterprise close sequences with security and legal pre-emption built in.",
  },
  {
    id: "call-007",
    rep: "Sarah Chen",
    ...
    date: "Jun 15, 2026",
    status: "Reviewed",
    pipelineAmount: "$47,000",
    lossReason: null,
    talkListenRatio: "40 / 60",
    scoreBreakdown: [
      { label: "Discovery", score: 9, outOf: 10, note: "Mapped the buying committee before the demo request." },
      { label: "Qualification", score: 9, outOf: 10, note: "Budget confirmed and timeline scoped in first 10 minutes." },
      { label: "Objection Handling", score: 8, outOf: 10, note: "Handled the integration concern with a live walkthrough." },
      { label: "Next Steps", score: 9, outOf: 10, note: "Pilot scope and decision date both locked." },
      { label: "Playbook Adherence", score: 8, outOf: 10, note: "Stayed on enterprise track with minor improvisation." },
    ],
    missedQuestions: ["Who signs off on legal review at this company?"],
    missedOpportunities: [],
    productInaccuracies: [],
    accountContext: {
      company: {
        ...
        salesMotion: "hybrid",
        pricingModel: "self-serve",
        productSummary: "Low-code platform for building collaborative apps and workflows.",
        targetCustomer: "Ops and product teams managing complex data workflows.",
        likelyUseCase: "Replacing spreadsheet-based project tracking with structured databases.",
        relevantTechnologies: ["Salesforce", "Slack", "Zapier"],
        recentSignals: [{ type: "product-launch", description: "Launched AI-powered field suggestions", date: "2026-05-14" }],
        buyingStageHypothesis: "solution-aware",
      },
      contact: {
        name: "Rachel Kim",
        email: "rachel@airtable.com",
      ...
      confidence: { company: 0.9, contact: 0.87, stage: 0.82, salesMotion: 0.84 },
      sources: { company: ["Exa company profile"], contact: ["LinkedIn profile"], retrievedAt: "2026-06-15T13:00:00Z" },
    },
    transcriptEvidence: [
      { title: "Committee mapping", quote: "Rep: Before we go deeper, who else will weigh in on the decision when you bring this back internally?" },
    ],
    bestMoment: "Mapped the full buying committee in the first ten minutes and adjusted the narrative for each stakeholder.",
    topMissedMoment: "Legal review ownership was left unconfirmed — could delay close.",
    buyerAwareFeedback: "Rachel is a director-level decision-maker at a hybrid-motion 201-1000 person company — the rep correctly scoped the committee and locked a pilot, which removed the most common stall for this buyer type.",
    recommendedDrill: "Practice legal and procurement pre-emption for director-level discovery calls.",
  },
  {
    id: "call-008",
    rep: "David Park",
    ...
    date: "Jun 19, 2026",
    status: "Reviewed",
    pipelineAmount: "$22,000",
    lossReason: "Buyer chose a competitor with a tighter integration story; rep could not articulate the migration path.",
    talkListenRatio: "58 / 42",
    scoreBreakdown: [
      { label: "Risk Discovery", score: 5, outOf: 10, note: "Competitor mention surfaced late; rep was unprepared." },
      { label: "Expansion Qualification", score: 6, outOf: 10, note: "Use case was underdeveloped for the expanded scope." },
      { label: "Objection Handling", score: 6, outOf: 10, note: "Integration objection was not resolved convincingly." },
      { label: "Next Steps", score: 6, outOf: 10, note: "Follow-up was vague with no committed date." },
      { label: "Playbook Adherence", score: 7, outOf: 10, note: "Playbook not well adapted to expansion context." },
    ],
    missedQuestions: [
      "What would have to be true for the competitor option to feel risky?",
      "Who else is evaluating this alongside you?",
    ],
    missedOpportunities: [
      "Competitor was mentioned at minute 12; rep did not pivot to differentiation until it was too late.",
      "Migration complexity was a known concern but the rep had no concrete migration story ready.",
    ],
    productInaccuracies: ["Overstated the depth of the native integration — buyer later found this to be incorrect."],
    accountContext: {
      company: {
        name: "Stripe",
        domain: "stripe.com",
        ...
        productSummary: "Payment infrastructure for the internet.",
        targetCustomer: "Developers and finance teams at scaling businesses.",
        likelyUseCase: "Expanding tooling for internal finance workflow automation.",
        relevantTechnologies: ["AWS", "Salesforce", "dbt"],
        recentSignals: [{ type: "expansion", description: "Expanded finance engineering team", date: "2026-05-10" }],
        buyingStageHypothesis: "vendor-evaluating",
      },
      contact: {
        name: "Tom Reyes",
        email: "tom@stripe.com",
        linkedinUrl: "https://linkedin.com/in/tomreyes",
        title: "Finance Engineering Lead",
        department: "Finance Engineering",
        seniority: "manager",
        likelyRoleInPurchase: "evaluator",
      },
      confidence: { company: 0.93, contact: 0.8, stage: 0.78, salesMotion: 0.82 },
      sources: { company: ["Exa company profile"], contact: ["LinkedIn profile"], retrievedAt: "2026-06-19T11:00:00Z" },
    },
    transcriptEvidence: [],
    bestMoment: "Identified the expansion use case correctly despite the buyer not volunteering it.",
    topMissedMoment: "Competitor mention at minute 12 was not handled — rep continued the feature demo without pivoting to differentiation.",
    buyerAwareFeedback: "Tom is a finance engineering evaluator at a 1000+ person public company with a strong integration requirement — the rep needed a ready migration story and a competitive pivot before the demo, not after.",
    recommendedDrill: "Run a competitive battlecard drill focused on integration objections and migration narratives.",
  },
  {
    id: "call-009",
    rep: "David Park",
    ...
    date: "Jun 15, 2026",
    status: "Reviewed",
    pipelineAmount: "$18,000",
    lossReason: "No decision — buyer deprioritised the expansion after an internal budget cut; rep did not create urgency early enough.",
    talkListenRatio: "61 / 39",
    scoreBreakdown: [
      { label: "Risk Discovery", score: 5, outOf: 10, note: "Budget risk was hinted at but never directly surfaced." },
      { label: "Expansion Qualification", score: 6, outOf: 10, note: "Expansion ROI was not quantified." },
      { label: "Objection Handling", score: 6, outOf: 10, note: "Budget freeze objection caught rep off guard." },
      { label: "Next Steps", score: 5, outOf: 10, note: "No follow-up meeting locked before the call ended." },
      { label: "Playbook Adherence", score: 6, outOf: 10, note: "Missed the urgency-creation step entirely." },
    ],
    missedQuestions: [
      "What happens if this expansion slips by a quarter?",
      "Has anything changed on your budget side since we last spoke?",
    ],
    missedOpportunities: [
      "Buyer mentioned a cost review happening next week — rep did not use this to create a decision deadline.",
      "The ROI case was never built; buyer had no internal justification to push back against the budget cut.",
    ],
    productInaccuracies: [],
    accountContext: {
      company: {
        ...
        salesMotion: "sales-led",
        pricingModel: "usage-based",
        productSummary: "Spend management and corporate cards for startups and enterprises.",
        targetCustomer: "Finance teams at high-growth companies.",
        likelyUseCase: "Expanding spend controls across newly onboarded business units.",
        relevantTechnologies: ["NetSuite", "Slack"],
        recentSignals: [{ type: "leadership-change", description: "New CFO joined from a public company", date: "2026-04-28" }],
        buyingStageHypothesis: "problem-aware",
      },
      contact: {
        name: "Sam Lee",
      ...
      confidence: { company: 0.88, contact: 0.82, stage: 0.75, salesMotion: 0.79 },
      sources: { company: ["Exa company profile"], contact: ["LinkedIn profile"], retrievedAt: "2026-06-15T09:00:00Z" },
    },
    transcriptEvidence: [],
    bestMoment: "Opened with a summary of value delivered in the current contract term.",
    topMissedMoment: "The cost review mention was a clear signal to create urgency — the rep moved on without addressing it.",
    buyerAwareFeedback: "Sam is a finance manager champion at a 201-1000 person fintech company with a new CFO scrutinising spend — the rep needed to build the ROI case and manufacture a decision deadline before budget constraints became the default reason to stall.",
    recommendedDrill: "Practice urgency creation and ROI quantification for renewal calls where internal budget risk is present.",
  },
  {
    id: "call-010",
    rep: "Michael Torres",
    ...
    date: "Jun 18, 2026",
    status: "Reviewed",
    pipelineAmount: "$11,000",
    lossReason: "Rep lost control of the demo; buyer got lost in features and disengaged before the close attempt.",
    talkListenRatio: "64 / 36",
    scoreBreakdown: [
      { label: "Discovery", score: 6, outOf: 10, note: "Did not recap pain before starting the demo." },
      { label: "Qualification", score: 7, outOf: 10, note: "Budget was touched but not confirmed." },
      { label: "Product Accuracy", score: 7, outOf: 10, note: "Feature depth was correct but context was missing." },
      { label: "Next Steps", score: 6, outOf: 10, note: "Close attempt was made without a clear decision frame." },
      { label: "Playbook Adherence", score: 6, outOf: 10, note: "Skipped the buyer recap section of the demo playbook." },
    ],
    missedQuestions: [
      "Before I show you anything, can I confirm the one thing that would make this a no-brainer for your team?",
      "What's your timeline if you decide to move forward?",
    ],
    missedOpportunities: [
      "Buyer disengaged at minute 18 — a check-in question would have recovered the conversation.",
      "No reference to the buyer's stated pain during the demo — it became a product tour.",
    ],
    productInaccuracies: [],
    accountContext: {
      company: {
        ...
        salesMotion: "hybrid",
        pricingModel: "self-serve",
        productSummary: "Customer messaging and support automation platform.",
        targetCustomer: "Support and product teams at mid-market companies.",
        likelyUseCase: "Consolidating inbound support across chat and email.",
        relevantTechnologies: ["Salesforce", "Slack", "Zendesk"],
        recentSignals: [{ type: "product-launch", description: "Launched AI-powered inbox assistant", date: "2026-05-22" }],
        buyingStageHypothesis: "vendor-evaluating",
      },
      contact: {
        name: "Dana Cho",
        email: "dana@intercom.com",
        linkedinUrl: "https://linkedin.com/in/danach",
        title: "Support Operations Lead",
        department: "Support",
        seniority: "manager",
        likelyRoleInPurchase: "evaluator",
      },
      confidence: { company: 0.89, contact: 0.79, stage: 0.77, salesMotion: 0.8 },
      sources: { company: ["Exa company profile"], contact: ["LinkedIn profile"], retrievedAt: "2026-06-18T14:00:00Z" },
    },
    transcriptEvidence: [],
    bestMoment: "Identified the support consolidation use case before opening the demo.",
    topMissedMoment: "Buyer went quiet at minute 18 and the rep kept presenting instead of checking in.",
    buyerAwareFeedback: "Dana is a support ops evaluator at a hybrid-motion company already using Zendesk — the rep needed to anchor every demo screen to the Zendesk migration pain, not run a generic product tour.",
    recommendedDrill: "Practice buyer-anchored demo delivery: open with the pain recap, check in every five screens, close on a specific decision frame.",
  },
  {
    id: "call-011",
    rep: "Michael Torres",
    ...
    score: 68,
    adherence: 63,
    outcome: "No advancement",
    date: "Jun 14, 2026",
    status: "Reviewed",
    pipelineAmount: "$8,500",
    lossReason: null,
    talkListenRatio: "60 / 40",
    scoreBreakdown: [
      { label: "Discovery", score: 6, outOf: 10, note: "Pain stayed surface-level; root cause not explored." },
      { label: "Qualification", score: 7, outOf: 10, note: "Timeline asked but not pinned to a business event." },
      { label: "Product Accuracy", score: 7, outOf: 10, note: "Value props described correctly but generically." },
      { label: "Next Steps", score: 6, outOf: 10, note: "Follow-up was left as 'I'll reach back out' — no date." },
      { label: "Playbook Adherence", score: 6, outOf: 10, note: "Discovery framework was not followed past the second question." },
    ],
    missedQuestions: [
      "What is the business impact if this problem isn't solved this quarter?",
      "Who on your team feels this pain most acutely?",
    ],
    missedOpportunities: [
      "Buyer mentioned team growth three times — rep never tied this to urgency or expansion potential.",
    ],
    productInaccuracies: [],
    accountContext: {
      company: {
        ...
        salesMotion: "hybrid",
        pricingModel: "self-serve",
        productSummary: "Shared inbox and customer communication platform.",
        targetCustomer: "Customer-facing teams at growing SMBs.",
        likelyUseCase: "Replacing siloed email inboxes with a shared team view.",
        relevantTechnologies: ["Gmail", "Slack"],
        recentSignals: [{ type: "hiring", description: "Growing support and customer success team", date: "2026-06-01" }],
        buyingStageHypothesis: "problem-aware",
      },
      contact: {
        name: "Ben Walsh",
        email: "ben@front.com",
        linkedinUrl: "https://linkedin.com/in/benwalsh",
        title: "Head of Customer Success",
        department: "Customer Success",
        seniority: "manager",
        likelyRoleInPurchase: "champion",
      },
      confidence: { company: 0.87, contact: 0.8, stage: 0.74, salesMotion: 0.77 },
      sources: { company: ["Exa company profile"], contact: ["LinkedIn profile"], retrievedAt: "2026-06-14T10:00:00Z" },
    },
    transcriptEvidence: [],
    bestMoment: "Asked about team growth before the product pitch.",
    topMissedMoment: "Growth was mentioned three times and never tied to a concrete buying reason.",
    buyerAwareFeedback: "Ben is a customer success champion at a 51-200 person Series A company actively hiring — team growth was practically a buying signal on its own, and the rep let it pass three times without building urgency around it.",
    recommendedDrill: "Practice converting growth signals into urgency: map headcount increase to inbox volume, then to cost of not solving it now.",
  },
]
